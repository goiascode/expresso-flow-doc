...
![Painel de chat do WebFlow mostrando uma conversa com o flow hellow](../assets/images/webflow/webflow-chat.png{ width="380" }
...
![Aba Console do painel de debug mostrando entradas sent, received, error, info e warning](../assets/images/webflow/webflow-panel-console.png{ width="380" }
...
![Aba Steps mostrando steps ACTIVE e COMPLETED do flow hellow](../assets/images/webflow/webflow-panel-steps.png{ width="380" }
...
![Aba Requests mostrando uma requisição POST com status 200](../assets/images/webflow/webflow-panel-requests.png{ width="380" }
...
![Modal de detalhes da requisição, aba Request, mostrando headers e body](../assets/images/webflow/webflow-modal-request-request.png{ width="640" }

Exibe os **headers** enviados na requisição e o **body** (payload).

#### Request Details — Response

![Modal de detalhes da requisição, aba Response, mostrando headers e body da resposta](../assets/images/webflow/webflow-modal-request-response.png{ width="640" }

Exibe os **headers** da resposta e o **body** retornado pela API.

#### Request Details — cURL

![Modal de detalhes da requisição, aba cURL, mostrando o comando curl equivalente](../assets/images/webflow/webflow-modal-request-curl.png{ width="640" }
...
![Aba Exceptions mostrando uma entrada ERROR](../assets/images/webflow/webflow-panel-exception.png{ width="380" }

Cada entrada mostra o nível (`ERROR`) e a mensagem da exceção. Clique para abrir o modal de detalhes.

#### Detalhe da Exceção

![Modal de detalhe de exceção mostrando MESSAGE e STACK TRACE](../assets/images/webflow/webflow-modal-exception.png{ width="640" }
